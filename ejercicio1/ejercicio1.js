...
const fruits = ['Banana', 'Strawberry', 'Orange']; //Cuando trabajamos con destructuring de arrays y no de objetos se ponen corchetes y no llaves
...
const [year1, year2, year3] = itv; //Cuidado! Va entre corchetes, no llaves, ya que es un array, no un objeto
